...
The retained central Package writer receives a narrow schema-compatibility
bridge: exactly one approved code on each of its three existing fixtures. It
remains transitional, keeps the whole-table guard and both writer methods,
and does not replace the future Ads-owned REFERENCE group.
...
## P8-06 Current Authority Overlay

This historical decomposition is now implemented by merged PR #143. P8-06
does not reopen its business decisions or runtime payloads. It inventories the
separate TEST fixture boundary in
...
## P8-06A Safety Boundary Preservation Overlay

P8-06A does not reopen or modify the completed DEV decomposition. It adds only
the separate TEST target safety and metadata contract documented in
[test-fixture-ownership-audit.md](test-fixture-ownership-audit.md).
