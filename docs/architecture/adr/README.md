...
| --- | --- | --- | --- |
| [0001](0001-storage-provider-and-access-policy.md) | Storage Provider And Access Policy | Accepted | Storage |
| [0002](0002-entity-ownership-and-persistence-boundaries.md) | Entity Ownership And Persistence Boundaries | Accepted | Persistence |
| [0003](0003-cross-module-transaction-policy.md) | Cross-Module Transaction Policy | Accepted | Cross-module persistence |
